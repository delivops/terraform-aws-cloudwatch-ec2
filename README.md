...
| <a name="input_status_check_failed_sns_arns"></a> [status\_check\_failed\_sns\_arns](#input\_status\_check\_failed\_sns\_arns) | List of ARNs for the SNS topics | `list(string)` | `[]` | no |
